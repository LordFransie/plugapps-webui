...
def index(request):
	...
	return render_to_response('system/index.html', stats)
...
def storage(request):
	...
	return render_to_response('system/storage.html', stats)
   
def networking(request):
	currentip = privateapi.core.getcurrentip()
	stats = { "currentip": currentip }
	return render_to_response('system/networking.html', stats)
    
  
def software(request):
	return render_to_response('system/software.html')
